                ...
                <form action='' method='post' id='passwordReset'>
                    <div id='row'>
                        ...
                        <div id='column-2'>
                            <div id='input-1'>
                                <div class='modalInput'>
                                    <input type='password' maxlength="50" class='passInput' id='oldPass' name='oldPass'
                                        required>
                                    <br />
                                </div>
                                <div class='modalInput'>
                                    <input type='password' maxlength="50" class='passInput' id='newPass' name='newPass'
                                        required>
                                    <br />
                                </div>
                                <div class='modalInput'>
                                    <input type='password' maxlength="50" class='passInput' id='confirmPass'
            ...
            <tr>
                ...
                <td id='tableColumn-2'>
                    <form action='#' method='post' enctype="multipart/form-data" id='editProfile' name='editProfile'>
                        ...
                        <input type='text' class='formInput' id='name' name='name' value='<?php echo $row['name']; ?>'>
                        <br />

                        <div class='formLabel'>Email Address</div>
                        <input type='email' class='formInput' id='email' name='email'
                            value='<?php echo $row['email_address']; ?>' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
                            readonly="readonly">
                        ...
                        <input type='password' class='formInput' id='pass' name='pass'
                        ...
                        <input type='tel' class='formInput' id='phone_num' name='phone_num'
                            value='<?php echo $row['contact_number']; ?>' onfocusout="phone_number()" require
                            pattern="[0-9]{10,11}" ;>
                        ...
                        <div class='formInput' id='gender'>
                            <input type='radio' class='radioBtn' name='gender' value='M' <?php if ($row['gender'] == 'M') { ?>checked='checked' <?php } ?>>Male</input>
                            <input type="radio" class='radioBtn' name='gender' value='F' <?php if ($row['gender'] == 'F') { ?>checked='checked' <?php } ?>>Female</input>
                        </div>
                        <br />
                        ...
                        <div class='formInput'>
                            <input type='date' id='date' name='dob' value='<?php echo $row['dob']; ?>'
                                onchange="validate_dob()">
                        </div>
                        <br />

...
<body onload="activeSlide()">
    <?php 
        ...
        $sql_pet = "SELECT available_status FROM pet WHERE petID = '8'";
    ...
    <div id='container'>      
        <div class='row'>
            ...
            <table class='tableDesign' >
                <tr>
                    <th colspan="4" id='gallery'>
                        <div class='topLeftTable'>
                            ...
                            <img src='img/maine_coon1-0.jpg' class='slideShow'>
                            <img src='img/maine_coon1-1.jpg' class='slideShow'>
                            <img src='img/maine_coon1-2.jpg' class='slideShow'>
                            <img src='img/maine_coon1-3.jpg' class='slideShow'>
                        </div>
                    </th>
                ...
                <tr id='gallery'>
                    <td>
                        <img src='img/maine_coon1-0.jpg' class='minimizedImg' onclick="slideChange(0)">
                    </td>    
                    <td>
                        <img src='img/maine_coon1-1.jpg' class='minimizedImg' onclick="slideChange(1)">
                    </td>  
                    <td>
                        <img src='img/maine_coon1-2.jpg' class='minimizedImg' onclick="slideChange(2)">
                    </td>  
                    <td>
                        <img src='img/maine_coon1-3.jpg' class='minimizedImg' onclick="slideChange(3)">
                    </td>
                </tr>   
            </table>
        ...
        <p>
            ...
            <form action='../../../Payment/payment.php' method='post'>
                ...
                <input type='text' name='petID' value='8' hidden>

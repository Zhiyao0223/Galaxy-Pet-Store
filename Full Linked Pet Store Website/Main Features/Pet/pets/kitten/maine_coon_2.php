    ...
    <div id='container'>
        <div class='row'>
            ...
            <table class='tableDesign' >
                <tr>
                    <th colspan="4" id='gallery'>
                        <div class='topLeftTable'>
                            ...
                            <img src='img/maine_coon2-0.jpg' class='slideShow'>
                            <img src='img/maine_coon2-1.jpg' class='slideShow'>
                            <img src='img/maine_coon2-2.jpg' class='slideShow'>
                            <img src='img/maine_coon2-3.jpg' class='slideShow'>
                        </div>
                    </th>
                    <td rowspan="2" style="width: 100%;vertical-align: top;">
                        <div class='content'>
                            ...
                            <p>
                                ...
                                <div class='price'>RM2800.00</div>
                            </p>
                            <p>
                                <div class='textCategory'>Age</div>: 2.5 months old
                            </p>
                            <p>
                                <div class='textCategory'>Color</div>: White & Orange
                            </p>
                            <p>
                ...
                <tr id='gallery'>
                    <td>
                        <img src='img/maine_coon2-0.jpg' class='minimizedImg' onclick="slideChange(0)">
                    </td>    
                    <td>
                        <img src='img/maine_coon2-1.jpg' class='minimizedImg' onclick="slideChange(1)">
                    </td>  
                    <td>
                        <img src='img/maine_coon2-2.jpg' class='minimizedImg' onclick="slideChange(2)">
                    </td>  
                    <td>
                        <img src='img/maine_coon2-3.jpg' class='minimizedImg' onclick="slideChange(3)">
                    </td>
                </tr>   
            </table>
        ...
        <p>
            ...
            <form action='../../../Payment/payment.php' method='post'>
                ...
                <input type='text' name='petID' value='9' hidden>

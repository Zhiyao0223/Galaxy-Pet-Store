    ...
    <div class='row'>
        <div id='column-1'>
            <form action="puppies.php" method="GET" id='filterFeature'>      
                ...
                <ol>
                    ...
                    <ul>
                        <li>
                            <input type='checkbox' name='breed' id='maine_coon' onclick="filterBox()">Maine Coon
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='shorthair' onclick="filterBox()">Shorthair
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='persian' onclick="filterBox()">Persian
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='ragdoll' onclick="filterBox()">Ragdoll
                        </li>
                    </ul>
                    <br/><hr style="opacity: 20%;"><br/>
        ...
        <div id='column-2'>
            <table id='tableDesign'>
                <?php
                    $sql_pet = "SELECT * FROM pet WHERE type ='kitten' AND available_status = '1'";
                        ...
                        $data = " 
                                <tr>
                                    <td class='tableColumn-1'>
                                        <a href='kitten/" .$link ."'><img src='kitten/img/" .$picture ."' class='img' alt='" .$breed ."'></a>
                                    </td>
                                    <td class='tableColumn-2'>
                                        <a href='kitten/" .$link ."' class='tableTitle' id='" .$breed ."'>" .$name ." (" .$gender .")</a><br/>"
                                        .$htmlElement ."
                                        <div class='priceBox'>

...
<body onload="activeSlide()">
    <?php 
        ...
        $sql_pet = "SELECT available_status FROM pet WHERE petID = '16'";
    ...
    <div id='container'>        
        <div class='row'>
            ...
            <table class='tableDesign' >
                <tr>
                    <th colspan="4" id='gallery'>
                        <div class='topLeftTable'>
                            ...
                            <img src='img/lovebird1-0.jpg' class='slideShow'>
                            <img src='img/lovebird1-1.jpg' class='slideShow'>
                            <img src='img/lovebird1-2.jpg' class='slideShow'>
                            <img src='img/lovebird1-3.jpg' class='slideShow'>
                        </div>
                    </th>
                    <td rowspan="2" style="width: 50%;vertical-align: top;">
                        <div class='content'>
                            <div id='textTitle'>Lovebird (Female) For Sale</div>
                            <p>
                                <div class='textCategory'>Price</div>: 
                                <div class='price'>RM200.00</div>
                            </p>
                            <p>
                                <div class='textCategory'>Age</div>: 2.5 months old
                            </p>
                            <p>
                                <div class='textCategory'>Color</div>: White
                            </p>
                            <p>
                ...
                <tr id='gallery'>
                    <td>
                        <img src='img/lovebird1-0.jpg' class='minimizedImg' onclick="slideChange(0)">
                    </td>    
                    <td>
                        <img src='img/lovebird1-1.jpg' class='minimizedImg' onclick="slideChange(1)">
                    </td>  
                    <td>
                        <img src='img/lovebird1-2.jpg' class='minimizedImg' onclick="slideChange(2)">
                    </td>  
                    <td>
                        <img src='img/lovebird1-3.jpg' class='minimizedImg' onclick="slideChange(3)">
                    </td>
                </tr>   
            </table>
        ...
        <p>
            ...
            <form action='../../../Payment/payment.php' method='post'>
                ...
                <input type='text' name='petID' value='16' hidden>

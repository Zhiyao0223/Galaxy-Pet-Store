...
<body>
    ...
    <div class='row'>
        <div id='column-1'>
            <form action="#" method="GET" id='filterFeature'>      
                <input type='text' oninput="filterBox()" class='fas fa-search fontSearchBox' id='searchBox' placeholder="&#xf002; Search for a pet here..." maxlength="30" >
                <br/><br/>
                ...
                <ol>
                    ...
                    <ul id="genderFilter">
                        <li>
                            <input type="radio" id='both' name='gender' value='both' onclick="filterBox()" checked>Both Gender<br/>
                    ...
                    <br/><hr style="opacity: 20%;"><br/>
        
                    <li>
                        <div id='filterCategories'>Breed</div>
                    </li>
                    <ul>
                        <li>
                            <input type='checkbox' name='breed' id='poodle' onclick="filterBox()">Poddle
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='pomeranian' onclick="filterBox()">Pomeranian
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='shiba_inu' onclick="filterBox()">Shiba-Inu
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='siberian_husky' onclick="filterBox()">Siberian Husky
                        </li>
                        <li>
                            <input type='checkbox' name='breed' id='welsh_corgi' onclick="filterBox()">Welsh Corgi
                        </li>
                    </ul>
                    <br/><hr style="opacity: 20%;"><br/>
                    ...
                    <ul>
                        <li>
                            <input type="number" class='priceRange' name='priceRange' min="1" max="10000" placeholder="RM MIN" oninput="filterBox()"> --- 
                            <input type='number' class='priceRange' name='priceRange' min="1" max="10000" placeholder="RM MAX" oninput="filterBox()">
                        </li>
                    </ul>
                    <br/><hr style="opacity: 20%;"><br/>
                    <li> 
                        <button type="reset" onclick="setTimeout('filterBox()', 150)" id='resetFilter'>Clear All Filter</button>
                    </li>
                </ol>
            </form>
        </div>
        ...
        <div id='column-2'>
            ...
            <?php
                    $sql_pet = "SELECT * FROM pet WHERE type ='puppies' AND available_status = '1'";
                        ...
                        $data = " 
                                <tr>
                                    <td class='tableColumn-1'>
                                        <a href='puppies/" .$link ."'><img src='puppies/img/" .$picture ."' class='img' alt='" .$breed ."'></a>
                                    </td>
                                    <td class='tableColumn-2'>
                                        <a href='puppies/" .$link ."' class='tableTitle' id='" .$breed ."'>" .$name ." (" .$gender .")</a><br/>"
                                        .$htmlElement ."
                                        <div class='priceBox'>

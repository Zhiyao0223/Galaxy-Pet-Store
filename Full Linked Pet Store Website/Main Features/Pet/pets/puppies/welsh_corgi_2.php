...
<body onload="activeSlide()">
    <?php 
        ...
        $sql_pet = "SELECT available_status FROM pet WHERE petID = '2'";
    ...
    <div id='container'>
        <div class='row'>
            ...
            <table class='tableDesign' >
                <tr>
                    <th colspan="4" id='gallery'>
                        <div class='topLeftTable'>
                            ...
                            <img src='img/corgi2-0.jpg' class='slideShow'>
                            <img src='img/corgi2-1.jpg' class='slideShow'>
                            <img src='img/corgi2-2.jpg' class='slideShow'>
                            <img src='img/corgi2-3.jpg' class='slideShow'>
                        </div>
                    </th>
                    <td rowspan="2" style="width: 50%;vertical-align: top;">
                        <div class='content'>
                            <div id='textTitle'>Pembroke Welsh Corgi (Male) For Sale</div>
                            <p>
                                <div class='textCategory'>Price</div>: 
                                <div class='price'>RM6000.00</div>
                            </p>
                            <p>
                                <div class='textCategory'>Age</div>: 1 years old
                            </p>
                            <p>
                ...
                <tr id='gallery'>
                    <td>
                        <img src='img/corgi2-0.jpg' class='minimizedImg' onclick="slideChange(0)">
                    </td>    
                    <td>
                        <img src='img/corgi2-1.jpg' class='minimizedImg' onclick="slideChange(1)">
                    </td>  
                    <td>
                        <img src='img/corgi2-2.jpg' class='minimizedImg' onclick="slideChange(2)">
                    </td>  
                    <td>
                        <img src='img/corgi2-3.jpg' class='minimizedImg' onclick="slideChange(3)">
                    </td>  
                </tr>   
            </table>
        ...
        <p>
            ...
            <form action='../../../Payment/payment.php' method='post'>
                ...
                <input type='text' name='petID' value='2' hidden>

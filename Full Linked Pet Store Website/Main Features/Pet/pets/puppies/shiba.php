    ...
    <div id='container'>        
        <div class='row'>
            ...
            <table class='tableDesign' >
                <tr>
                    <th colspan="4" id='gallery'>
                        <div class='topLeftTable'>
                            ...
                            <img src='img/shiba1-0.jpg' class='slideShow'>
                            <img src='img/shiba1-1.jpg' class='slideShow'>
                            <img src='img/shiba1-2.jpg' class='slideShow'>
                            <img src='img/shiba1-3.jpg' class='slideShow'>
                        </div>
                    </th>
                    <td rowspan="2" style="width: 50%;vertical-align: top;">
                        <div class='content'>
                            <div id='textTitle'>Shiba Inu (Male) For Sale</div>
                            <p>
                            ...
                            <p>
                                <div class='textCategory'>Additional Information</div>: MKA cert and microchip
                            </p>
                            <p>
                ...
                <tr id='gallery'>
                    <td>
                        <img src='img/shiba1-0.jpg' class='minimizedImg' onclick="slideChange(0)">
                    </td>    
                    <td>
                        <img src='img/shiba1-1.jpg' class='minimizedImg' onclick="slideChange(1)">
                    </td>  
                    <td>
                        <img src='img/shiba1-2.jpg' class='minimizedImg' onclick="slideChange(2)">
                    </td>  
                    <td>
                        <img src='img/shiba1-3.jpg' class='minimizedImg' onclick="slideChange(3)">
                    </td>
                </tr>   
            </table>
        ...
        <p>
            ...
            <form action='../../../Payment/payment.php' method='post'>
                ...
                <input type='text' name='petID' value='5' hidden>

    ...
    <div class="row">
      <div id="billing">
        ...
        <input
          ...
          id="address"
          name="address"
          placeholder="No XX, Bandar Sepang"
          required="required"
        />
      ...
      <div id="payment">
        ...
        <input
          ...
          id="ccnum"
          name="cardnumber"
          placeholder="4012888877881881"
          onfocusout="creditnum()"
          maxlength="16"
          required="required"
          required
          pattern="[0-9]{16}"

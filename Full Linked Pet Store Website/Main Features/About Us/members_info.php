            ...
            <div class="row">
                <div class="col-md-3 profile text-center">
                    <div class="image">
                        ...
                        <ul>
                            <a href="https://www.instagram.com/mannoj_/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/MannojSakthivel"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/mannoj.sakthivel"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                    <h2>Mannoj Sakthivel</h2>
                    <h3><u>Director / CEO</u></h3>
                    <p>The head of the department. Founded the Pet Store with Zhi Yao and Lit Tsen in 2021 while still a diploma student in Asia Pacific University </p>
                </div>
                <div class="col-md-3 profile text-center">
                    <div class="image">
                    <img src="img/zhiyao.jpg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/zhiyao0223/"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="#"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/Xiiaowu.xD"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                    <h2>Ng Zhi Yao</h2>
                    <h3><u>Financial Head / CFO</u></h3>
                    <p>Controls the Financial Aspect of the Pet Store. Studied Business in Computing at Harvard in 2020</p>
                </div>
                <div class="col-md-3 profile text-center">
                    <div class="image">
                    <img src="img/ibrahmovic.jpg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/littxenn/"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="#"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/littxenn"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                    <h2>Ong Lit Tsen</h2>
                    <h3><u>Operating Head / COO</u></h3>
                    <p>Controls all oporating aspects of the company. Studied accounting at University of Malaya at 1995</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3 profile text-center">
                    ...
                    <img src="img/john_cena.jpg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/johncena/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/JohnCena?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/johncena"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                        <h2>John Cena</h2>
                        <h3><u>Technology Head / CTO</u></h3>
                        <p>Incharge of Technological devices or components at the Pet Store. Has been in the Pet Store industry for 20 years </p>
                </div>
                <div class="col-md-3 profile text-center">
                    <div class="image">
                    <img src="img/jihyo.jpeg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/jypjihyo/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://www.facebook.com/JYPETWICE"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                        <h2>Park Ji-hyo</h2>
                ...
                <div class="col-md-3 profile text-center">
                    ...
                    <img src="img/Vin_Diesel.jpg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/vindiesel/"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/vindiesel?lang=en"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/VinDiesel"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                        <h2>Vin Diesel</h2>
                        <h3><u>Chief Internal Ambassador</u></h3>
                        <p>Has been doing ambassadorial work for 10 years. Has a famous quote saying "The most important thing in 
            ...
            <div class="row">
                <div class="col-md-3 profile text-center">
                    ...
                    <img src="img/lisasurihani.jpg" class="img-responsive" width="300" height="400">
                        <ul>
                            <a href="https://www.instagram.com/lisasurihani/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/lisasurihani?lang=en"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/LisaSurihani23"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                    <h2>Lisa Surihani</h2>
                ...
                <div class="col-md-3 profile text-center">
                    <div class="image">
                        ...
                        <ul>
                            <a href="https://www.instagram.com/shraddhakapoor/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/ShraddhaKapoor"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/ShraddhaKapoor"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                ...
                <div class="col-md-3 profile text-center">
                    <div class="image">
                        ...
                        <ul>
                            <a href="https://www.instagram.com/thisisbillgates/?hl=en"><li><i class="fa fa-instagram"></i></li></a>
                            <a href="https://twitter.com/BillGates"><li><i class="fa fa-twitter"></i></li></a>
                            <a href="https://www.facebook.com/BillGates"><li><i class="fa fa-facebook"></i></li></a>
                        </ul>
                    </div>
                    <h2>Bill Gates</h2>
                ...
                <p>Contact us at</p><a href='tel: +0380825740' style= "text-align: center; margin-bottom: 1rem; font-size: 13px; color: white;">+0380825740</a><p> or email us at</p>
                <a style= "text-align: center; font-size: 13px; color: white;" href = "https://outlook.live.com/mail/0/inbox" target="_blank" >petstorepetaling@hotmail.com</a>
            </div>
        </div>
    </section>

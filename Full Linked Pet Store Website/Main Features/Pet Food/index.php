        ...
        <section class="product" id="product">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Smart Heart Chicken" onclick='add()'>Add to cart</button></p>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Monge Fresh 100G" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="DR KERESDog Food" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Alps Natural Chunk" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Paradise 10kg" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Soft Pet Food S $ C" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Adragna Premium Lamb 5kg" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Iskhan Holistic Senior 1.2KG" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Royal Canin Health Nutrition" onclick='add()'>add to cart</button></p>
                </div>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Misha cat food" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="dzahara Adult" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Whiskas 80/85kg" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Petland cat food" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="leonardo Cat Food" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="benefeed Feline C & T" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="reflex Plus Adult" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="equilibrio Adult Dry" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Dormeos Longhair" onclick='add()'>add to cart</button></p>
                </div>
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="AquaNice XinYang Trophical Gold" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Takana Sakana-il F-Pallets" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Sanyu Guppy Mini Floating Pallets" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Shogun Advance Pallets" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Trophical Gold Fish Food" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="hulx Gold - Special Mix" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="AquaNice Premium Koi" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Atlas 5kg Fast Red Koi" onclick='add()'>add to cart</button></p>
                </div>
                ...
                <div class="box">
                    ...
                    <p><button type="submit" name="food_name" value="Aqua Master koi fish" onclick='add()'>add to cart</button></p>
                </div>

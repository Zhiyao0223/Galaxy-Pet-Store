        ...
        <input type="hidden" name="accessoriesID" value="<?php echo$row['accessoriesID']?>">
            <table>
                <tr>
                    ...
                    <td>: <input type="text" name="name" required="required" value="<?php echo $row['accessories_name'] ?>"></td>
                </tr>

                <tr>
                    <td><label>Price (RM)</label></td>
                    <td>: <input type="number" name="price" required="required" min='0' step='0.10' value="<?php echo $row['accessories_price'] ?>"></td>
                </tr>

                <tr>
                    <td><label>Image Name</label></td>
                    <td>: <input type="text" name="image" required="required" value="<?php echo $row['accessories_image'] ?>"></td>
                </tr>

...
<body>
  ...
  <form method='get'>
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Cat Collars &#128570;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            <img src="images/ccollar1.jpg" alt="collar" width="200" height="200" />
            <h4>Blue Collar + bell</h4>
            <p>RM35</p>
            <p><button type="submit" name="accessory" value="Blue Collar + bell" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/ccollar2.jpg" alt="collar" width="200" height="200" />
            <h4>Blue & Orange Collar</h4>
            <p>RM50</p>
            <p><button type="submit" name="accessory" value="Blue & Orange Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/ccollar3.jpg" alt="collar" width="200" height="200" />
            <h4>Pink & Black Collar</h4>
            <p>RM55</p>
            <p><button type="submit" name="accessory" value="Pink & Black Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/ccollar4.jpg" alt="collar" width="200" height="200" />
            <h4>Red Nylon Collar + Red bell</h4>
            <p>RM33</p>
            <p><button type="submit" name="accessory" value="Red Nylon Collar + Red bell" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/ccollar5.jpg" alt="collar" width="200" height="200" />
            <h4>Red Nylon Collar + Blue bell</h4>
            <p>RM59.90</p>
            <p><button type="submit" name="accessory" value="Red Nylon Collar + Blue bell" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/ccollar6.jpg" alt="collar" width="200" height="200" />
            <h4>Red Leather Collar</h4>
            <p>RM85</p>
            <p><button type="submit" name="accessory" value="Red Leather Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/ccollar7.jpg" alt="collar" width="200" height="200" />
            <h4>Blue Collar + Silver bell</h4>
            <p>RM68</p>
            <p><button type="submit" name="accessory" value="Blue Collar + Silver bell" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/ccollar8.jpg" alt="collar" width="200" height="200" />
            <h4>Blue Collar + gold bell</h4>
            <p>RM58</p>
            <p><button type="submit" name="accessory" value="Blue Collar + gold bell" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Cat Leash &#128008;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            <img src="images/catleash1.jpg" alt="leash" width="200" height="200" />
            <h4>Orange Leash</h4>
            <p>RM20</p>
            <p><button type="submit" name="accessory" value="Orange Leash" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash2.jpg" alt="leash" width="200" height="200" />
            <h4>Red Leash</h4>
            <p>RM36</p>
            <p><button type="submit" name="accessory" value="Red Leash" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash3.jpg" alt="leash" width="200" height="200" />
            <h4>Purple Nylon Leash &#128293;</h4>
            <p>RM49</p>
            <p><button type="submit" name="accessory" value="Purple Nylon Leash" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/catleash4.jpg" alt="leash" width="200" height="200" />
            <h4>Deep Blue Retractable Leash</h4>
            <p>RM60</p>
            <p><button type="submit" name="accessory" value="Deep Blue Retractable Leash" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash5.jpg" alt="leash" width="200" height="200" />
            <h4>Blue Leash</h4>
            <p>RM24</p>
            <p><button type="submit" name="accessory" value="Blue Leash" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash6.jpg" alt="leash" width="200" height="200" />
            <h4>Purple Leash</h4>
            <p>RM57</p>
            <p><button type="submit" name="accessory" value="Purple Leash" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash7.jpg" alt="leash" width="200" height="200" />
            <h4>Mix Colored Leash</h4>
            <p>RM66</p>
            <p><button type="submit" name="accessory" value="Mix Colored Leash" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/catleash8.jpg" alt="leash" width="200" height="200" />
            <h4>Black Leash + leopard pattern</h4>
            <p>RM67</p>
            <p><button type="submit" name="accessory" value="Black Leash + leopard pattern" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Cat Clothes &#128090;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            <img src="images/cclothes1.jpg" alt="clothes" width="200" height="200" />
            <h4>Red Sweater</h4>
            <p>RM80</p>
            <p><button type="submit" name="accessory" value="Red Sweater" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/cclothes2.jpg" alt="clothes" width="200" height="200" />
            <h4>Pink Sweater (Cats)</h4>
            <p>RM99</p>
            <p><button type="submit" name="accessory" value="Pink Sweater (Cats)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/cclothes3.jpg" alt="clothes" width="200" height="200" />
            <h4>Blue Sweater</h4>
            <p>RM110</p>
            <p><button type="submit" name="accessory" value="Blue Sweater" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/cclothes4.jpg" alt="clothes" width="200" height="200" />
            <h4>Deep Pink Windbreaker</h4>
            <p>RM140</p>
            <p><button type="submit" name="accessory" value="Deep Pink Windbreaker" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/cclothes5.jpg" alt="clothes" width="200" height="200" />
            <h4>Pink Hoodie</h4>
            <p>RM80</p>
            <p><button type="submit" name="accessory" value="Pink Hoodie" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/cclothes6.jpg" alt="clothes" width="200" height="200" />
            <h4>Black Bow Tie</h4>
            <p>RM23</p>
            <p><button type="submit" name="accessory" value="Black Bow Tie" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/cclothes7.jpg" alt="clothes" width="200" height="200" />
            <h4>Yellow Skirt</h4>
            <p>RM57</p>
            <p><button type="submit" name="accessory" value="Yellow Skirt" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/cclothes8.jpg" alt="clothes" width="200" height="200" />
            <h4>White Unicorn Hoodie</h4>
            <p>RM108</p>
            <p><button type="submit" name="accessory" value="White Unicorn Hoodie" onclick='add()'>Add to cart</button>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="small-box">
        ...
        <div class="row">
          ...
          <div class="column-03">
            ...
            <p>RM308</p>
            <p><button type="submit" name="accessory" value="White & Black Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM208</p>
            <p><button type="submit" name="accessory" value="Soft Blue Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM258</p>
            <p><button type="submit" name="accessory" value="White & Red Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM308</p>
            <p><button type="submit" name="accessory" value="White & Grey Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM328</p>
            <p><button type="submit" name="accessory" value="Yellow & Black Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM315</p>
            <p><button type="submit" name="accessory" value="Peach & Dark Green Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>

...
<body>
  ...
  <form method='get'>
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Dog Collars &#128021;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            <img src="images/collar1.jpg" alt="collar" width="200" height="200" />
            <h4>Red Collar</h4>
            <p>RM65</p>
            <p><button type="submit" name="accessory" value="Red Collar" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/collar2.jpg" alt="collar" width="200" height="200" />
            <h4>Collar with treat tag</h4>
            <p>RM69</p>
            <p><button type="submit" name="accessory" value="Collar with treat tag" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/collar3.jpg" alt="collar" width="200" height="200" />
            <h4>Red & White Collar</h4>
            <p>RM72</p>
            <p><button type="submit" name="accessory" value="Red & White Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/collar4.jpg" alt="collar" width="200" height="200" />
          ...
          <div class="column-03">
            <img src="images/collar5.jpg" alt="collar" width="200" height="200" />
            <h4>Blue Collar &#128293;</h4>
            <p>RM75</p>
            <p><button type="submit" name="accessory" value="Blue Collar" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/collar6.jpg" alt="collar" width="200" height="200" />
            <h4>Black Leather Collar</h4>
            <p>RM169</p>
            <p><button type="submit" name="accessory" value="Black Leather Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/collar7.jpg" alt="collar" width="200" height="200" />
            <h4>Brown Leather Collar</h4>
            <p>RM172</p>
            <p><button type="submit" name="accessory" value="Brown Leather Collar" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/collar8.jpg" alt="collar" width="200" height="200" />
            <h4>Metal Collar</h4>
            <p>RM180</p>
      ...
      <div class="small-box">
        ...
        <div class="row">
          <div class="column-03">
            ...
            <p>RM23.90</p>
            <p><button type="submit" name="accessory" value="Red Nylon Leash (dogs)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            <img src="images/leash3.jpg" alt="collar" width="200" height="200" />
          ...
          <div class="column-03">
            ...
            <p>RM60</p>
            <p><button type="submit" name="accessory" value="Brown Leather Leash" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM67</p>
            <p><button type="submit" name="accessory" value="Red Retractable Leash" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Dog Clothes &#128085;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            <img src="images/clothes1.jpg" alt="clothes" width="200" height="200" />
            <h4>Blue & White Stripes</h4>
            <p>RM75</p>
            <p><button type="submit" name="accessory" value="Blue & White Stripes" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/clothes2.jpg" alt="clothes" width="200" height="200" />
            <h4>Pink Collored Sweater</h4>
            <p>RM86</p>
            <p><button type="submit" name="accessory" value="Pink Collored Sweater" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/clothes3.jpg" alt="clothes" width="200" height="200" />
            <h4>Pink Sweater</h4>
            <p>RM83</p>
            <p><button type="submit" name="accessory" value="Pink Sweater" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/clothes4.jpg" alt="clothes" width="200" height="200" />
            <h4>Colorful Checkered</h4>
            <p>RM108</p>
            <p><button type="submit" name="accessory" value="Colorful Checkered" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/clothes5.jpg" alt="clothes" width="200" height="200" />
            <h4>White Sweater</h4>
            <p>RM80</p>
            <p><button type="submit" name="accessory" value="White Sweater" onclick='add()'>Add to cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/clothes6.jpg" alt="clothes" width="200" height="200" />
            <h4>Yellow Windbreaker</h4>
            <p>RM123</p>
            <p><button type="submit" name="accessory" value="Yellow Windbreaker" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            <img src="images/clothes7.jpg" alt="clothes" width="200" height="200" />
            <h4>Black & White Suit+Bow Tie</h4>
            <p>RM156</p>
            <p><button type="submit" name="accessory" value="Black & White Suit+Bow Tie" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            <img src="images/clothes8.jpg" alt="clothes" width="200" height="200" />
            <h4>Santa Hat</h4>
            <p>RM118</p>
      ...
      <div class="small-box">
        ...
        <div class="row">
          <div class="column-03">
            ...
            <p>RM360</p>
            <p><button type="submit" name="accessory" value="White/Peach Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM376</p>
            <p><button type="submit" name="accessory" value="White Pet Fence (Medium)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM468</p>
            <p><button type="submit" name="accessory" value="Black Metal Fence (Medium)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM408</p>
            <p><button type="submit" name="accessory" value="Neon Green/Black (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM768</p>
            <p><button type="submit" name="accessory" value="Stainless Steel Cage (Large)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM348</p>
            <p><button type="submit" name="accessory" value="Dark Blue/Grey Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM388</p>
            <p><button type="submit" name="accessory" value="Aqua/White (Small)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM365</p>
            <p><button type="submit" name="accessory" value="Black Metal Cage (Medium)" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>

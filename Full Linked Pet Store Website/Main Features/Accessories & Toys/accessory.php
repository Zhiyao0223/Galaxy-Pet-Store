...
<html lang="en">
  ...
  <body>
    ...
    <div class="category">
      <div class="small-box">
        <h2><center>Popular Items &#128293;</center></h2>
        <br />
        <div class="row">
          <div class="column-03">
            <a href="dogs.php"
          ...
          <div class="column-03">
            <a href="dogs.php"
              ><img src="images/cage1.jpg" alt="cage" width="300" height="300"
            /></a>
    ...
    <!-- Popular toys-->
    <div class="small-box">
      <h2><center>Popular Toys &#x26BE;</center></h2>
      <br />
      <div class="row">
        <div class="column-04">
          <a href="toys.php"
      ...
      <!--Latest clothes-->
      <h2><center>Latest Clothes &#128087;</center></h2>
      <br />
      <div class="row">
        <div class="column-04">
          <a href="cats.php"

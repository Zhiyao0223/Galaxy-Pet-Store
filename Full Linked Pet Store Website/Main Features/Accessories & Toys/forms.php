  ...
  <form action="booking_form.php" method="post">
    ...
    <div id="container">
      ...
      <div class="section">
        ...
        <div class="field">
          :
          <input type="tel" id="telephone" name="phone_num" onfocusout="phone_number()" required="required" />
        </div>
      </div>
      <div class="section">
      ...
      <div class="section">
        ...
        <div class="field">
          :
          <input type="radio" name="animals" value="Dog" required="required" />
          Dog
          <input type="radio" name="animals" value="Cats" required="required" />
          Cat
        </div>
      </div>
      <div class="section">
      ...
      <div class="section">
        ...
        <div class="field">
          :
          <input type="date" id="booking_date" name="booking_date" onchange="booking()" required />
        </div>
      </div>
      <div class="section">
        ...
        <div class="field">
          :
          <input type="time" id="bookingTime" name="booking_time" onfocusout="hour()" required />
        </div>
      </div>
      <div class="section">
        <div class="label">&nbsp;</div>
        <div class="field">
          <input type="submit" value="Submit" onclick="return phone_number()" />

      ...
      <div class="small-box">
        ...
        <div class="row">
          <div class="column-03">
            ...
            <p>RM55</p>
            <p><button type="submit" name="accessory" value="Dog Bone (chewable)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM68</p>
            <p><button type="submit" name="accessory" value="Giraffe Toy (chewable)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM32</p>
            <p><button type="submit" name="accessory" value="Blue Dog Bone (chewable)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM23</p>
            <p><button type="submit" name="accessory" value="Colorful String Toy" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM49.90</p>
            <p><button type="submit" name="accessory" value="Fluffy Raindeer (chewable)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM85</p>
            <p><button type="submit" name="accessory" value="Fluffy White Chicken (chewable)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM28</p>
            <p><button type="submit" name="accessory" value="Yellow Pig Toy (chewable)" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>
      ...
      <div class="small-box">
        ...
        <div class="row">
          ...
          <div class="column-03">
            ...
            <p>RM18</p>
            <p><button type="submit" name="accessory" value="Colorful Fish Toy (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM15</p>
            <p><button type="submit" name="accessory" value="Orange Plastic Ball" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
      ...
      <div class="small-box">
        ...
        <div class="row">
          <div class="column-03">
            ...
            <p>RM18.90</p>
            <p><button type="submit" name="accessory" value="Yellow & Pink Toy Ball+Bell" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM19.90</p>
            <p><button type="submit" name="accessory" value="Pink Hemisphere+White Strings" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>

...
<body>
  ...
  <form method='get'>
    ...
    <div class="category">
      <div class="small-box">
        <h2>
          <center>Birds Feeder (Food Tray) &#128038;</center>
        </h2>
        <br />
        <div class="row">
          <div class="column-03">
            ...
            <p>RM56</p>
            <p><button type="submit" name="accessory" value="Plastic Bird Feeder" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM63</p>
            <p><button type="submit" name="accessory" value="Net Bird Feeder (Plastic Base)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM69.90</p>
            <p><button type="submit" name="accessory" value="Net Bird Feeder (Metal Base)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM85</p>
            <p><button type="submit" name="accessory" value="Orange & Black Bird Feeder" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM98</p>
            <p><button type="submit" name="accessory" value="Wooden House Bird Feeder" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM58</p>
            <p><button type="submit" name="accessory" value="Plastic Bird Feeder (Green Base)" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>
      ...
      <div class="small-box">
        ...
        <div class="row">
          <div class="column-03">
            ...
            <p>RM80</p>
            <p><button type="submit" name="accessory" value="SilverCage (Small)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM166</p>
            <p><button type="submit" name="accessory" value="Silver Cage (Large)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM228</p>
            <p><button type="submit" name="accessory" value="White Cage (Large)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
          ...
          <div class="column-03">
            ...
            <p>RM318</p>
            <p><button type="submit" name="accessory" value="Black Cage (Large)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM308</p>
            <p><button type="submit" name="accessory" value="Bamboo Designed Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
          <div class="column-03">
            ...
            <p>RM118</p>
            <p><button type="submit" name="accessory" value="Purple Cage (Small)" onclick='add()'>Add to cart</button>
            </p>
          </div>
          <div class="column-03">
            ...
            <p>RM215</p>
            <p><button type="submit" name="accessory" value="Gold & Pink Cage (Small)" onclick='add()'>Add to
                cart</button></p>
          </div>
        </div>
      </div>
